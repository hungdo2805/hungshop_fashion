    ...
    public function index()
    {
        return view($this->templatePath . '.screen.shop_home',
            array(
                ...
                'list_news' => (new ShopNews)->setLimit('6')->getData(),
                'partners' => (new ShopPartner)->setLimit('6')->setSort(['sort', 'asc'])->getData(),
                'instagram_photos' => (new InstagramPhoto)->setLimit('6')->setSort(['sort', 'asc'])->getData(),
                'deal_product' => (new DealProduct)->first(),
        ...
        if ($news) {
            return view(
                ...
                array(
                    ...
                    'latest_news' =>(new ShopNews)->setLimit(5)->getData(),
