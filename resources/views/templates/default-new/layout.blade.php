...
{{--     <link href="https://fonts.googleapis.com/css?family=Roboto:300,400|Rufina:700&display=swap" rel="stylesheet">
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/bootstrap.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/font-awesome.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/themify-icons.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/elegant-icons.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/owl.carousel.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/nice-select.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/jquery-ui.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/slicknav.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset($templateFile.'/css2/style.css')}}" type="text/css"> 
...
{{--     <script src="{{ asset($templateFile.'/lib/js/jquery.js')}}"></script>
    ...
    <script src="{{ asset($templateFile.'/js2/jquery-3.3.1.min.js')}}"></script>
    <script src="{{ asset($templateFile.'/js2/bootstrap.min.js')}}"></script>
    <script src="{{ asset($templateFile.'/js2/jquery-ui.min.js')}}"></script>
    <script src="{{ asset($templateFile.'/js2/jquery.countdown.min.js')}}"></script>
    <script src="{{ asset($templateFile.'/js2/jquery.nice-select.min.js')}}"></script>
   {{--  <script src="{{ asset($templateFile.'/js2/jquery.zoom.min.js')}}"></script> --}}
   <script src="{{ asset($templateFile.'/js2/jquery.zoom.js')}}"></script>
    <script src="{{ asset($templateFile.'/js2/jquery.dd.min.js')}}"></script>
    <script src="{{ asset($templateFile.'/js2/jquery.slicknav.js')}}"></script>
    <script src="{{ asset($templateFile.'/js2/owl.carousel.min.js')}}"></script>
    <script src="{{ asset($templateFile.'/js2/main.js')}}"></script>
