                        ...
                        <tbody>
                            ...
                            <tr class="row_cart form-group {{ session('arrErrorQty')[$product->id] ?? '' }}{{ (session('arrErrorQty')[$product->id] ?? 0) ? ' has-error' : '' }}">
                                ...
                                <td class="cart-col-qty">
                                    <div class="cart-qty">
                                        <button type="button" onclick="buttonQty($(this), 'reduce');">-</button>
                                        <input style="width: 70px;" type="number" data-id="{{ $item->id }}"
                                            data-rowid="{{$item->rowId}}" onChange="updateCart($(this));"
                                            class="item-qty" name="qty-{{$item->id}}" value="{{$item->qty}}">
                                            ...
                                            <div class="form-group cart-payment-method">
                                                ...
                                                <div class="cart-payment-item">
                                                    <input type="radio" name="paymentMethod"
                                                        value="{{ $payment['key'] }}" id="payment-{{ $payment['key'] }}"
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="pull-right">
                                        <button class="btn btn-success" id="submit-order" type="submit"
                                            style="cursor: pointer;padding:10px 30px"><i class="fa fa-check"></i>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="cart-table">
                        <table>
                            ...
                            <tbody>
                                ...
                                @endphp
                                <tr>
                                    <td class="cart-pic first-row"><img src="{{asset($product->getImage())}}" alt=""></td>
                                    ...
                                    <td class="p-price first-row">{!! $product->showPrice() !!}</td>
                                    <td class="qua-col first-row">

                                        <div class="cart-qty">
                                                
                                            <input style="width: 100px;border:1px solid #ccc;"type="number"  data-id="{{ $item->id }}"
                                                data-rowid="{{$item->rowId}}" onChange="updateCart($(this));"
                                                class="item-qty" name="qty-{{$item->id}}" value="{{$item->qty}}">
                                        </div>
                                        <span class="text-danger item-qty-{{$item->id}}" style="display: none;"></span>
                                    ...
                                    <td class="total-price first-row">{{sc_currency_render($item->subtotal)}}</td>
                                    <td class="close-td first-row">
                                        <a onClick="return confirm('{{trans('front.cart_sure_delete')}}')" title="Remove Item" alt="Remove Item"
                                        class="cart_quantity_delete"
                                        href="{{route("cart.remove",['id'=>$item->rowId])}}"><i class="ti-close"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="pull-right">
                                <button class="btn btn-danger" type="button"
                                    onClick="if(confirm('{{trans('front.cart_all_delete')}}')) window.location.href='{{ route('cart.clear') }}';">
                                    <i class="fa fa-window-close" aria-hidden="true"></i>
                                    {{ trans('cart.remove_all') }}</button>
                            </div>
                        </div>
               ...
               <div class="col-md-12 checkout-section">
                    <form class="sc-shipping-address checkout-form" id="form-order" role="form" method="POST"
                        action="{{ route('cart.process') }}" class="checkout-form">
                        <div class="row">
                            <div class="col-md-7">
                                @if (auth()->user())
                                <div class="">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group cart-payment-method">
                                                    @foreach ($paymentMethod as $key => $payment)
                                                    <span class="cart-payment-item fix-width-input" >
