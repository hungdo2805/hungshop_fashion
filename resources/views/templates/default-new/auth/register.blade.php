...
<form action="{{route('postRegister')}}" method="post" class="box">
    {!! csrf_field() !!}
    <div class="form_content mt-3" id="collapseExample">

        @if (sc_config('customer_lastname'))
        <div class="group-input form-group{{ $errors->has('reg_first_name') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group{{ $errors->has('reg_last_name') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group{{ $errors->has('reg_first_name') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control {{ ($errors->has('reg_first_name'))?"input-error":"" }}"
                name="reg_first_name" placeholder="{{ trans('account.name') }}" value="{{ old('reg_first_name') }}">
            @if ($errors->has('reg_first_name'))
            <span class="help-block">
                {{ $errors->first('reg_first_name') }}
            </span>
        ...
        <div class="group-input form-group{{ $errors->has('reg_email') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group{{ $errors->has('reg_phone') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group{{ $errors->has('reg_postcode') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group{{ $errors->has('reg_address1') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group{{ $errors->has('reg_address2') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group{{ $errors->has('reg_company') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group  {{ $errors->has('reg_country') ? ' has-error' : '' }}">
        ...
        <div class="group-input form-group{{ $errors->has('reg_sex') ? ' has-error' : '' }}">
            <label
        ...
        <div class="group-input form-group{{ $errors->has('reg_birthday') ? ' has-error' : '' }}">
            <input type="date"
        ...
        <div class="group-input form-group{{ $errors->has('reg_group') ? ' has-error' : '' }}">
            <input type="text"
        ...
        <div class="group-input form-group{{ $errors->has('reg_password') ? ' has-error' : '' }}">
            <input type="password"
        ...
        <div class="group-input form-group{{ $errors->has('reg_password_confirmation') ? ' has-error' : '' }}">
            <input type="password"
        ...
        <div class="submit">
            <button type="submit" name="SubmitCreate" class="site-btn login-btn">{{ trans('account.title_register') }}</button>
        </div>
    </div>
