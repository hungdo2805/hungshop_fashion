...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      ...
      <tr>
        <td>{{ trans('store_info.pinterest') }}</td>
        <td><a href="#" class="fied-required editable editable-click" data-name="pinterest" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.pinterest') }}" data-value="{{ $infos->pinterest }}" data-original-title="" title="">{{$infos->pinterest }}</a></td>
      </tr>
